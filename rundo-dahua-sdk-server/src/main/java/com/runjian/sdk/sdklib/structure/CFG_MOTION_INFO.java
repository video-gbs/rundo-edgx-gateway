...
import static com.runjian.sdk.sdklib.NetSDKLib.MAX_REC_TSECT;
import static com.runjian.sdk.sdklib.constant.SDKStructureFieldLenth.*;

/**
 * @author 47081
 * @description 动态监测报警配置,对应接口 {@link
 *     com.runjian.sdk.sdklib.NetSDKLib#CLIENT_GetNewDevConfig(NetSDKLib.LLong, String, int, byte[], int,

 ...
 */
@Component
public class TalkLivePlayStartMsgServiceImpl implements InitializingBean, IMsgProcessorService {
    ...
    public void afterPropertiesSet() throws Exception {
        iMqMsgDealServer.addRequestProcessor(StreamBusinessMsgType.TALK_LIVE_START.getTypeName(),this);
    }

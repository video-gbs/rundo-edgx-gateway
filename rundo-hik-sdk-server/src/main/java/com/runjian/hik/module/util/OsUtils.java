...
public class OsUtils {
    ...
    public static String getLoadLibrary() {
        ...
        String osPrefix = getOsPrefix();
        if (osPrefix.toLowerCase().startsWith("win32-x86")) {
            loadLibrary = System.getProperty("user.dir") + File.separator + "hikvision" + File.separator + "windows" + File.separator + "x32"+ File.separator;
            library = "HCNetSDK.dll";
        } else if (osPrefix.toLowerCase().startsWith("win32-amd64")) {
            loadLibrary = System.getProperty("user.dir") + File.separator + "hikvision" + File.separator + "windows" + File.separator + "x64"+ File.separator;
            library = "HCNetSDK.dll";
        } else if (osPrefix.toLowerCase().startsWith("linux-i386")) {
            //同 linux-amd64
            loadLibrary = System.getProperty("user.dir") + File.separator + "hikvision" + File.separator + "linux" + File.separator + "x32"+ File.separator;
            ...
            loadLibrary = System.getProperty("user.dir") + File.separator + "hikvision" + File.separator + "linux" + File.separator + "x64"+ File.separator;
            library = "libhcnetsdk.so";
        }

...
@Component
@Slf4j
public class DefensesWithdrawServiceImpl implements InitializingBean, IMsgProcessorService {
                ...
                if (!ObjectUtils.isEmpty(channelArr)){
                    ...
                    channelArr.forEach(channelObj->{
                        ...
                        try {
                            ...
                            log.error(LogTemplate.ERROR_LOG_TEMPLATE,"撤防失败",e);

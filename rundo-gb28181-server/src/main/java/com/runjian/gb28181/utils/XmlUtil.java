...
//            logger.warn(LogTemplate.PROCESS_LOG_TEMPLATE, "基于dom4j的工具包", "解析Catalog消息时发现缺少 DeviceID");
//            return null;
//        }
//        String channelId = channdelIdElement.getTextTrim();
//        if (ObjectUtils.isEmpty(channelId)) {
//            logger.warn(LogTemplate.PROCESS_LOG_TEMPLATE, "基于dom4j的工具包", "解析Catalog消息时发现缺少 ChannelId");
//            return null;
//        }

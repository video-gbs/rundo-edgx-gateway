...
public class DeviceRecordSpeedMsgServiceImpl implements InitializingBean, IMsgProcessorService {
    ...
    public void afterPropertiesSet() throws Exception {
        iMqMsgDealServer.addRequestProcessor(GatewayBusinessMsgType.DEVICE_RECORD_SPEED.getTypeName(),this);
    }
    ...
    public void process(CommonMqDto commonMqDto) {
        ...
        try {
            Integer statusCode = iplayService.playSpeedControl(streamId,speed);
            if(statusCode!=0){

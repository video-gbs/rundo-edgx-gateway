 ...
 * {@link com.runjian.sdk.sdklib.NetSDKLib#CLIENT_QueryNewSystemInfo(NetSDKLib.LLong, String, int, byte[], int, IntByReference, int)}
 * @date 2020/11/9
 */
public enum EM_NEW_QUERY_SYSTEM_INFO {
    ...
    /**
     * 获取云台能力集
     * 对应结构体{@link com.runjian.sdk.sdklib.structure.CFG_PTZ_PROTOCOL_CAPS_INFO}
     */

...
public class StreamPushItem extends GbStream implements Comparable<StreamPushItem>{
    ...
    public int compareTo(@NotNull StreamPushItem streamPushItem) {
        return Long.valueOf(DateUtils.yyyy_MM_dd_HH_mm_ssToTimestamp(super.createTime)
                - DateUtils.yyyy_MM_dd_HH_mm_ssToTimestamp(streamPushItem.getCreateTime())).intValue();
    }

...
@Component
public class DeviceRecordResumeMsgServiceImpl implements InitializingBean, IMsgProcessorService {
    ...
    public void afterPropertiesSet() throws Exception {
        iMqMsgDealServer.addRequestProcessor(GatewayBusinessMsgType.DEVICE_RECORD_RESUME.getTypeName(),this);
    }
...
//        JSONObject dataMapJson = dataJson.getJSONObject("dataMap");
        ...
        try {
            Integer statusCode = iplayService.playResumeControl(streamId);
            if(statusCode!=0){
        ...
        //mq消息发送
        gatewayBusinessAsyncSender.sendforAllScene(response, commonMqDto.getMsgId(), GatewayBusinessMsgType.DEVICE_RECORD_RESUME);
    }
